...
One reason is, that even with seemingly converged caustics there still are a few very small areas with high difference, which just might be noise.
Nonetheless images with caustic paths are accessible via the links and it is interesting to see the difference between the fresnel approximations manifest on indirectly lit surfaces.
